        ...
        for page_num, positions in mots_cles_positions.items():
            ...
            for (start, end) in positions:
                try:
                    ...
                    print(f"Recherche du texte '{text_segment}' sur la page {page_num}...")
                    ...
                    if rects:
                        ...
                        print(f"Aucune correspondance exacte pour '{text_segment}' à la page {page_num}.")
                except Exception as e:
                    print(f"Erreur surlignage pour '{text_segment}' à la page {page_num} : {e}")
